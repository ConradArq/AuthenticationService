...
using AuthenticationService.Shared.Configurations;
...
namespace AuthenticationService.Shared.Helpers
{
    ...
    public static class QueryHelper
    {
        ...
        /// <param name="additionalCondition">An additional condition to combine with the resulting predicate.</param>
            ...
            Expression<Func<T, bool>>? additionalCondition = null)
        {
            ...
            // Combine the built predicate with the additionalCondition, if provided
            if (additionalCondition != null)
            {
                var additionalPredicateBody = Expression.Invoke(additionalCondition, parameter);
                predicate = propertyLogicalOperation == LogicalOperation.And
                    ? Expression.AndAlso(predicate, additionalPredicateBody)
                    : Expression.OrElse(predicate, additionalPredicateBody);
            }
