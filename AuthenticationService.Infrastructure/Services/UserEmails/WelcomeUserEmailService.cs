...
{
    public class WelcomeUserEmailService : IUserEmailService<WelcomeEmailDto>
    {
        private readonly IServiceScopeFactory _serviceScopeFactory;
        private readonly IEmailQueueService _emailQueueService;

        public WelcomeUserEmailService(IServiceScopeFactory serviceScopeFactory, IEmailQueueService emailQueueService)
        {
        ...
        public void SendEmail(object applicationUserId)
        {
            ...
            Func<Task<Email>> buildEmailFuncAsync = async () =>
            {
                using (var scope = _serviceScopeFactory.CreateScope())
                {
                    ...
                    string? emailTemplateFileName = configuration["Paths:Templates:Emails:Files:Welcome"];
                    ...
                    var emailDto = mapper.Map<WelcomeEmailDto>(applicationUser);
                    ...
                    email.Subject = string.Format(EmailTemplateMessages.WelcomeEmailSubject, applicationUser.FirstName);
